...
public class leaderBoard : MonoBehaviour {
	...
	private void Awake() {
		if(ObscuredPrefs.GetString("Bonus")=="Off"){
			BonusUI.score=ObscuredPrefs.GetInt("Leader");
			FieldScore.text=BonusUI.score.ToString();
		}
	...
	void Start () {
		...
		pnConfiguration.PublishKey = "pub-c-75fcd70d-4e8e-4465-aed1-317f08007e8b";
		pnConfiguration.SubscribeKey = "sub-c-af2a1638-dbf6-11ea-9cea-12703a486eb8";
